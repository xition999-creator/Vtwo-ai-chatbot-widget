(function () {
  ...
  const bgBorder = scriptTag?.getAttribute('data-bg-border') || 'rgba(255,255,255)';
  const bgsecGlow = scriptTag?.getAttribute('data-bg-secGlow') || 'rgb(57, 183, 226)';
  const bgEGlow = scriptTag?.getAttribute('data-bg-EGlow') || 'rgb(31, 243, 31)';
  const bgCGlow = scriptTag?.getAttribute('data-bg-CGlow') || 'purple';

  const bgUTBubble = scriptTag?.getAttribute('data-bg-UTBubble') || 'rgba(105, 111, 117, 0.281)';
  const bgATBubble = scriptTag?.getAttribute('data-bg-ATBubble') || 'rgba(105, 111, 117, 0.281)';
  const bgUCBubble = scriptTag?.getAttribute('data-bg-UCBubble') || 'white';
  const bgACBubble = scriptTag?.getAttribute('data-bg-ACBubble') || 'white';

  const bgTGlow = scriptTag?.getAttribute('data-bg-TGlow') || 'rgb(57, 183, 226)';
  const bgIGlow = scriptTag?.getAttribute('data-bg-IGlow') || 'purple';
